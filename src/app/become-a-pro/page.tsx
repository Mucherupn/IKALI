  ...
  return (
    <div className="section-shell max-w-4xl py-10">
      <header className="card-premium bg-[#111827] p-6 text-white sm:p-8">
        ...
        <p className="mt-3 text-gray-300">Join Kenya&apos;s premium local services network and get matched with serious customers.</p>
      </header>
      <div className="card-premium mt-6 p-6">
        ...
        <ul className="mt-4 list-disc space-y-2 pl-5 text-gray-700">
          ...
          <li>Service area within your area and surrounding zones</li>
